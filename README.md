...
```bash
curl -fsSL https://raw.githubusercontent.com/mapick-ai/mapickii/v0.0.5/install.sh | bash
```

Or with `wget`:

```bash
wget -qO- https://raw.githubusercontent.com/mapick-ai/mapickii/v0.0.5/install.sh | bash
```

Pin a specific version:

```bash
MAPICKII_VERSION=v0.0.5 bash -c "$(curl -fsSL https://raw.githubusercontent.com/mapick-ai/mapickii/main/install.sh)"
```
